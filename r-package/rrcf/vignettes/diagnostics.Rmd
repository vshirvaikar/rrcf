...
Two common diagnostics to evaluate if the identifying assumptions behind rrcf hold is a propensity score histogram and covariance balance plot.
...
For another way to assess heterogeneity, see the function [rank_average_treatment_effect](https://rrcf-labs.github.io/rrcf/reference/rank_average_treatment_effect.html) and the accompanying [vignette](https://rrcf-labs.github.io/rrcf/articles/rate.html).
