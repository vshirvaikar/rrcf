---
title: "Introduction to rrcf"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rrcf}
...
of how to use other types of forests, please consult the R [documentation](https://rrcf-labs.github.io/rrcf/reference/index.html) on the relevant methods.
